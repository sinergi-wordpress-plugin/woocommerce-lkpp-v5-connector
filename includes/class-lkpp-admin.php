...
class Warranty_Admin {
    ...
    function admin_scripts() {
        ...
        if ( isset($_GET['page']) && in_array( $_GET['page'], $pages ) ) {
            ...
            wp_localize_script( 'user-email-search', 'user_email_search', array(
        ...
        if ( isset($_GET['page']) ) {
            ...
            if (in_array( $_GET['page'], $pages ) ) {
                ...
                $data = array(
                    ...
                    'tips' => WooCommerce_Warranty::$tips
                );
        ...
        ?>
            <script type="text/javascript">
                jQuery(document).ready(function($) {
                    ...
                    $("#woocommerce-product-data").bind("woocommerce_variations_loaded woocommerce_variations_added", function() {
                        $(".warranty_default_checkbox").change();
                        $(".variable-warranty-type").change();
                        $(".variable-included-warranty-length").change();
                    });
                });
            </script>
        <?php
    ...
    public static function get_warranty_actions( $id, $html = false ) {
        ...
        $refunds_status     = get_option( 'warranty_refunds_statuses', array('completed') );
        ...
        if ( is_array( $refunds_status ) && in_array( $request['status'], $refunds_status ) ) {
    ...
    ?>
        <a class="button tips inline-rma dashicons-before dashicons-controls-repeat" data-tip="<?php esc_attr_e( 'Manage Return', 'woocommerce-pip' ); ?>" href="#">
        </a>
    <?php
    }
